...
export const OnboardingGoalsScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.stepIndicator}>Passo 2 de 7</Text>
      <Text style={styles.title}>Quais seus objetivos de bem-estar?</Text>
      <Text style={styles.subtitle}>Escolha um ou mais objetivos</Text>
